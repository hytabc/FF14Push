...
BONUS_NAMES = {
    ...
    "fishChancePct": "特殊鱼概率",
    "craftMaterialSavePct": "材料节省",
    "craftExtraOutputPct": "额外产出",
    "craftQualityJumpPct": "品质跃升",
    "gatherExtraActionPct": "额外采集",
    "gatherRareChancePct": "珍稀采集",
    "gatherDoublePct": "满载",
    "fishDoubleCatchPct": "双钩",
}
SLOT_BONUS = {
...
DOHDOL_TERMS = [
    {"id": "dohRarityLuck", "name": "品阶幸运", "category": "doh", "type": "buff", "trigger": "常驻",
     "stat": "craftRarityPct", "range": [2, 10], "slots": DOH_SLOTS, "desc": "制造品阶概率 +{v}%"},
    {"id": "dohQualityInsight", "name": "品质洞察", "category": "doh", "type": "buff", "trigger": "常驻",
    ...
    {"id": "dohClumsy", "name": "笨拙", "category": "doh", "type": "debuff", "trigger": "常驻",
     "stat": "craftSpeedPct", "range": [-12, -3], "slots": DOH_SLOTS, "desc": "制造速度 {v}%"},
    {"id": "dolHarvest", "name": "丰收", "category": "dol", "type": "buff", "trigger": "常驻",
     "stat": "gatherYieldPct", "range": [3, 15], "slots": DOL_SLOTS, "desc": "采集产量 +{v}%"},
    {"id": "dolSwiftGather", "name": "疾采", "category": "dol", "type": "buff", "trigger": "常驻",
     "stat": "gatherSpeedPct", "range": [3, 12], "slots": DOL_SLOTS, "desc": "采集速度 +{v}%"},
    {"id": "dolAnglingJoy", "name": "钓趣", "category": "fish", "type": "buff", "trigger": "常驻",
    ...
    # 扩展（见 docs/enchant-terms-expansion-design.md 第 6 节）
    {"id": "dohFrugal", "name": "节俭", "category": "doh", "type": "buff", "trigger": "触发",
     "stat": "craftMaterialSavePct", "range": [5, 20], "slots": DOH_SLOTS, "desc": "制造时 {v}% 概率不消耗材料"},
    {"id": "dohProlific", "name": "多产", "category": "doh", "type": "buff", "trigger": "触发",
     "stat": "craftExtraOutputPct", "range": [3, 12], "slots": DOH_SLOTS, "desc": "制造时 {v}% 概率额外产出 1 件"},
    {"id": "dohMasterpiece", "name": "杰作", "category": "doh", "type": "buff", "trigger": "触发",
     "stat": "craftQualityJumpPct", "range": [2, 8], "slots": DOH_SLOTS, "desc": "制造品质跃升概率 +{v}%"},
    {"id": "dolExtraAction", "name": "勤采", "category": "dol", "type": "buff", "trigger": "触发",
     "stat": "gatherExtraActionPct", "range": [3, 12], "slots": DOL_SLOTS, "desc": "采集时 {v}% 概率额外采集一次"},
    {"id": "dolRareFind", "name": "珍稀", "category": "dol", "type": "buff", "trigger": "触发",
     "stat": "gatherRareChancePct", "range": [3, 10], "slots": DOL_SLOTS, "desc": "采集时 {v}% 概率获得双份材料"},
    {"id": "dolDoubleHaul", "name": "满载", "category": "dol", "type": "buff", "trigger": "触发",
     "stat": "gatherDoublePct", "range": [3, 12], "slots": DOL_SLOTS, "desc": "采集时 {v}% 概率产量翻倍"},
    {"id": "dolDoubleCatch", "name": "双钩", "category": "fish", "type": "buff", "trigger": "触发",
     "stat": "fishDoubleCatchPct", "range": [3, 12], "slots": DOL_SLOTS, "desc": "钓鱼时 {v}% 概率双倍鱼获"},
    {"id": "dohWasteful", "name": "浪费", "category": "doh", "type": "debuff", "trigger": "触发",
     "stat": "craftMaterialSavePct", "range": [-20, -5], "slots": DOH_SLOTS, "desc": "制造额外消耗材料概率 {v}%"},
    {"id": "dohBarren", "name": "减产", "category": "doh", "type": "debuff", "trigger": "触发",
     "stat": "craftExtraOutputPct", "range": [-12, -3], "slots": DOH_SLOTS, "desc": "额外产出概率 {v}%"},
    {"id": "dohFlawed", "name": "瑕疵", "category": "doh", "type": "debuff", "trigger": "触发",
     "stat": "craftQualityJumpPct", "range": [-8, -2], "slots": DOH_SLOTS, "desc": "品质跃升概率 {v}%"},
    {"id": "dolIdle", "name": "怠惰", "category": "dol", "type": "debuff", "trigger": "触发",
     "stat": "gatherExtraActionPct", "range": [-12, -3], "slots": DOL_SLOTS, "desc": "额外采集概率 {v}%"},
    {"id": "dolBarren", "name": "空手", "category": "dol", "type": "debuff", "trigger": "触发",
     "stat": "gatherRareChancePct", "range": [-10, -3], "slots": DOL_SLOTS, "desc": "获得双份材料概率 {v}%"},
    {"id": "dolBadCatch", "name": "脱钩", "category": "fish", "type": "debuff", "trigger": "触发",
     "stat": "fishDoubleCatchPct", "range": [-12, -3], "slots": DOL_SLOTS, "desc": "双倍鱼获概率 {v}%"},
]
# 生产/采集词条类别名表（id → 中文名）。
DOHDOL_TERM_CATEGORIES = [
    {"id": "doh", "name": "生产"},
    {"id": "dol", "name": "采集"},
    {"id": "fish", "name": "钓鱼"},
]
...
dump("dohdol-equipment.json", {
    ...
    "termCategories": DOHDOL_TERM_CATEGORIES,
    "terms": DOHDOL_TERMS,
    "items": dohdol_items,
})
...
dump("consumables.json", {
    ...
    "effectNames": {
        ...
        "fishInsightPct": "捕鱼人之识时长",
        "fishChancePct": "特殊鱼概率", "gatherYieldPct": "采集产量",
    },
    "items": consumables,
})
