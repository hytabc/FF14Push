...
| 抽箱 | 6 种箱子、连抽档位 **单抽/十连/50 连/100 连**（50 连需一次性 1 亿金币解锁、100 连 5 亿，账号级解锁后所有箱子通用）、品阶概率、10/50/200 抽保底。抽奖动画按品阶给物品描边着色（`ChestReel`）；50/100 连用网格波浪揭晓。档位与解锁价见 `shared/data/chests.json:drawCounts` |
