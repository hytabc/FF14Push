...
| 副本 | 6 个副本，分两档：**普通**（4 个，Lv20-80）门槛 = 穿满 + 全部 ≥蓝色 + 至少 6 件紫色；**高难**（2 个，Lv80/100）门槛 = 穿满 + 全部 ≥传说 + 至少 6 件神话 + **每件装备至少 1 个太古词条**。无小怪、属性按英雄等级锚定后大幅放大、BOSS 自带抗性；双 BOSS 可切换目标，一方阵亡后另一方狂暴（逼同步击杀）。首通重奖、重刷少量金币，通关时间由服务端按理论下限校验 |
