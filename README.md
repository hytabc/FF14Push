...
| 图鉴 | 装备（按底材 × 品阶）、怪物、词条（普通/稀有/太古三档）、材料（采集材料 + 半成品）、鱼获（普通鱼 / 鱼王 / 鱼皇，按钓场） |
...
| 等级 | 所有能工巧匠共用**生产等级**，所有大地使者共用**采集等级**（上限 **100**，与英雄一致）；由制造 / 采集 / 钓鱼获得经验。专用装备覆盖 Lv.1-100（11 档 × 变体），采集点等级门槛按地区铺满 1-100 |
...
- **变体**：同档位多套底材（见 `base-items.json:variants`），除副属性池与档位缩放不同外，图标按变体做**色调混合**（暴击=红、直击=青、信念=紫、力量/敏捷/智力…）并在右上角加变体角标，因此同档不同变体一眼可辨。
