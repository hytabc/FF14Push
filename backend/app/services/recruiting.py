...
NAME_POOL = [
    ...
    "塔塔露", "敏菲利亚", "帕帕力莫", "伊达", "莉瑟", "可露儿",
    "芙·拉敏", "穆恩布瑞达", "古·拉哈·提亚", "路易索瓦",
    "娜娜莫", "劳班", "皮平", "梅尔维布", "嘉恩·艾·神纳",
    "艾默里克", "奥尔什方", "露琪亚", "伊塞勒", "托尔丹七世",
    "夕雾", "飞燕", "豪雪", "汉考克",
    "芝诺斯", "盖乌斯", "尼禄",
    "水晶公", "菲奥·乌儿", "兰吉特", "沃斯里", "阿尔博特",
    "爱梅特赛尔克", "希斯拉德", "维涅斯", "赫尔墨斯", "梅蒂恩",
    "拉哈布雷亚", "艾里迪布斯", "法丹尼尔",
    "乌克·拉玛特", "柯纳", "埃伦维尔", "佐拉加",
    "罗薇娜", "西德", "杰西", "比格斯", "魏吉", "希尔达", "月面监视者",
]
